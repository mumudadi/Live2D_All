...
live2d_settings['waifuToolLine']        = '24px';       // 工具栏行高，例如 '20px', '36px'
...
function initModel(waifuPath, type) {
    ...
    live2d_settings.homePageUrl = live2d_settings.homePageUrl == 'auto' ? window.location.protocol+'//'+window.location.hostname+'/live2d-test/' : live2d_settings.homePageUrl;
